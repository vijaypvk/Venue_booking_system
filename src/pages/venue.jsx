    ...
    <div className="dashboard flex bg-gray-100 min-h-screen">
      ...
      <div className="flex flex-col p-4 w-full lg:w-4/5">
        ...
        <div className="flex justify-between items-center">
          ...
          <Link to={"/addvenue1"}>
            <button className="flex items-center focus:outline-none text-white bg-[#27AE60] hover:bg-green-500 focus:ring-2 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
